...
function recreateWithSvgNamespace(element) {
  ...
  for (var _i2 = 0; _i2 < element.childNodes.length; _i2++) {
    var child = element.childNodes[_i2];
...
var SubComponent = function SubComponent(props) {
  ...
  return (0, index_1.createElement)("div", {
    style: {
      border: "1px solid black",
      margin: "0.5em 0",
      padding: "0.5em"
    }
  }, (0, index_1.createElement)("div", null, "Text is: ", props.someText), (0, index_1.createElement)("div", null, "Children:", (0, index_1.createElement)("div", null, props.children)), (0, index_1.createElement)("textarea", {
...
var SvgNamespaceTest = function SvgNamespaceTest() {
  return (0, index_1.createElement)("div", null, (0, index_1.createElement)("h2", null, "SVG Namespace Test"), (0, index_1.createElement)("p", null, "Testing overlapping HTML/SVG tags inside SVG elements:"), (0, index_1.createElement)("svg", {
    width: "300",
    height: "200",
    style: {
      border: '1px solid black'
    }
  }, (0, index_1.createElement)("rect", {
    x: "10",
    y: "10",
    width: "80",
    height: "80",
    fill: "red"
  }), (0, index_1.createElement)("circle", {
    cx: "150",
    cy: "50",
    r: "30",
    fill: "blue"
  }), (0, index_1.createElement)("line", {
    x1: "10",
    y1: "100",
    x2: "100",
    y2: "100",
    stroke: "green",
    strokeWidth: "2"
  }), (0, index_1.createElement)("a", {
    href: "#test"
  }, (0, index_1.createElement)("title", null, "SVG Title Element"), (0, index_1.createElement)("text", {
    x: "10",
    y: "130",
    fill: "purple"
  }, "Clickable SVG Text")), (0, index_1.createElement)("style", null, ".svg-style { fill: orange; }"), (0, index_1.createElement)("a", {
    href: "#link1"
  }, (0, index_1.createElement)("text", {
    x: "10",
    y: "170",
    fill: "red"
  }, "SVG Link 1")), (0, index_1.createElement)("a", {
    href: "#link2"
  }, (0, index_1.createElement)("text", {
    x: "150",
    y: "170",
    fill: "blue"
  }, "SVG Link 2"))), (0, index_1.createElement)("p", null, (0, index_1.createElement)("strong", null, "All elements above should use SVG namespace (http://www.w3.org/2000/svg)")), (0, index_1.createElement)("h3", null, "HTML Elements (for comparison)"), (0, index_1.createElement)("p", null, "Compare with HTML elements which use HTML namespace:"), (0, index_1.createElement)("a", {
    href: "#html-link1"
  }, "HTML Link 1"), (0, index_1.createElement)("a", {
    href: "#html-link2"
  }, "HTML Link 2"), (0, index_1.createElement)("a", {
    href: "#html-link3"
  }, "HTML Link 3"), (0, index_1.createElement)("p", null, "Before the fix: overlapping tags like <a>, <title>, <style> would use HTML namespace"), (0, index_1.createElement)("p", null, "After the fix: all elements inside <svg> automatically use SVG namespace"));
};
...
var StatefulSvgTest = function StatefulSvgTest(props) {
  ...
  for (var i = 0; i < props.count; i++) {
    ...
    circles.push((0, index_1.createElement)("circle", {
      key: i,
      cx: x,
      cy: y,
      r: "15",
      fill: "hsl(".concat(hue, ", 70%, 60%)"),
      stroke: "black",
      strokeWidth: "1"
    }));
  }

  return (0, index_1.createElement)("div", null, (0, index_1.createElement)("h2", null, "Stateful SVG Test"), (0, index_1.createElement)("p", null, "Click the links below to add more circles (count: ", props.count, "):"), (0, index_1.createElement)("svg", {
    width: "350",
    height: "200",
    style: {
      border: '1px solid black'
    }
  }, (0, index_1.createElement)("defs", null, (0, index_1.createElement)("pattern", {
    id: "grid",
    width: "40",
    height: "40",
    patternUnits: "userSpaceOnUse"
  }, (0, index_1.createElement)("path", {
    d: "M 40 0 L 0 0 0 40",
    fill: "none",
    stroke: "#ddd",
    strokeWidth: "1"
    ...
    height: "100%",
    fill: "url(#grid)"
  }), circles, (0, index_1.createElement)("a", {
    href: "#",
    ...
    fill: "blue",
    fontSize: "12"
  }, "Add One")), (0, index_1.createElement)("a", {
    href: "#",
    onClick: function onClick(e) {
      e.preventDefault();
      props.buttonClick();
    ...
    fill: "green",
    fontSize: "12"
  }, "Add More")), (0, index_1.createElement)("text", {
    x: "175",
    y: "175",
    fill: "black",
    fontSize: "12"
  }, "Count: ", props.count)), (0, index_1.createElement)("p", null, (0, index_1.createElement)("strong", null, "Demonstrates:")), (0, index_1.createElement)("ul", null, (0, index_1.createElement)("li", null, "SVG namespace working with stateful components"), (0, index_1.createElement)("li", null, "Interactive SVG links calling React-style event handlers"), (0, index_1.createElement)("li", null, "Dynamic rendering based on state (circles increase with count)"), (0, index_1.createElement)("li", null, "All SVG elements properly namespaced despite overlapping HTML tag names (<a>, <text>, etc.)")));
};
...
var NullPropsTest = function NullPropsTest(props) {
  return (0, index_1.createElement)("div", null, (0, index_1.createElement)("h3", null, "Null Props Test"), (0, index_1.createElement)("p", null, "Props received: ", JSON.stringify(props)), (0, index_1.createElement)("p", null, "Children: ", Array.isArray(props.children) ? props.children.join(', ') : 'none'));
};

exports.NullPropsTest = NullPropsTest; // Test for the runtime error fix

var RuntimeErrorTest = function RuntimeErrorTest() {
  return (0, index_1.createElement)("div", null, (0, index_1.createElement)("h2", null, "Runtime Error Fix Test"), (0, index_1.createElement)("p", null, "Testing component with null props but children provided:"), index_1.createElement(exports.NullPropsTest, null, 'Child 1', 'Child 2', 'Child 3'), (0, index_1.createElement)("p", null, "If you can see the content above, the null props issue is fixed!"));
};
...
var Layout = function Layout(props) {
  return (0, es6_1.createElement)("div", null, (0, es6_1.createElement)("h1", {
    className: "foo"
  }, props.title), props.input, (0, es6_1.createElement)("div", null, "count is: ", props.count), (0, es6_1.createElement)("button", {
    onClick: function onClick() {
      return props.buttonClick();
    }
  }, "add"), (0, es6_1.createElement)("button", {
    onClick: function onClick() {
      return props.buttonClick();
    },
    style: {
  ...
  }, "I also add"), (0, es6_1.createElement)("button", {
    onClick: function onClick() {
      return props.buttonClick();
    },
    disabled: true,
  ...
  }, "this is disabled.."), (0, es6_1.createElement)("button", {
    onClick: function onClick() {
      return props.buttonClick();
    },
    disabled: false,
    ...
    return (0, es6_1.createElement)(subcomponent_1.SubComponent, {
      someText: t,
      textAreaChange: function textAreaChange(v) {
        return props.textAreaChange(i, v);
      }
    }, "component ", i, " content");
  }), "namespaced element (svg):", (0, es6_1.createElement)("div", null, (0, es6_1.createElement)("svg", {
    width: "100",
    height: "100"
  }, (0, es6_1.createElement)("rect", {
    width: "100%",
    height: "100%",
    style: {
      fill: 'none',
  ...
  }))), (0, es6_1.createElement)(svg_namespace_test_1.SvgNamespaceTest, null), (0, es6_1.createElement)(stateful_svg_test_1.StatefulSvgTest, {
    count: props.count,
    buttonClick: props.buttonClick
  }), (0, es6_1.createElement)(runtime_error_test_1.RuntimeErrorTest, null));
};
...
var input = (0, index_1.createElement)("input", {
...
function updateRetainFocus() {
  ...
  var a = (0, index_1.getActiveElementInfo)();
  update(); //re-set the focus and selectionrange after the update

  (0, index_1.setActiveElement)(a);
}

function update() {
  (0, index_1.mount)( //note: the layout will detach and append our input above, so it loses its focus and selectionrange.
